...
@section('title', 'Add User - MyDispatch Admin')
...
@section('content')
    <div class="container" style="padding: 2rem 20px; max-width: 600px;">
        <div class="section-header" style="margin-bottom: 2rem;">
            ...
            <p style="color: #737373;">Create a new user account</p>
        </div>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    <label class="form-label" style="display: block; margin-bottom: 0.5rem; color: #a3a3a3;">Full
                        Name</label>
                    <input type="text" name="name" class="form-input" value="{{ old('name') }}" placeholder="John Doe"
                        required
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    <label class="form-label"
                        style="display: block; margin-bottom: 0.5rem; color: #a3a3a3;">Password</label>
                    <input type="password" name="password" class="form-input" placeholder="••••••••" required
                        style="width: 100%; padding: 0.75rem 1rem; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; color: white;">
                </div>

                <div class="form-group" style="margin-bottom: 2rem;">
                    <label class="form-label" style="display: block; margin-bottom: 0.5rem; color: #a3a3a3;">Confirm
                        Password</label>
