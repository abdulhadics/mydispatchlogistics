...
@section('content')
                            ...
                            <div class="card-content">
                                ...
                                @else
                                    @foreach ($recentLoads as $load)
                                        <div class="load-item">
                                            <div class="load-info">
                                                <div class="load-route">{{ $load->pickup_location }} → {{ $load->delivery_location }}</div>
                                    ...
                                    @foreach ($recentLoads as $load)
                                        <div class="shipment-item">
                                            <div class="shipment-info">
                                                <div class="shipment-route">{{ $load->pickup_location }} → {{ $load->delivery_location }}</div>
    ...
    .stat-change.neutral { color: #a3a3a3; }
    ...
    .load-item, .shipment-item, .payment-item {
        display: flex;
        justify-content: space-between;
        align-items: center;
        padding: 1rem 0;
    ...
    .load-item:last-child, .shipment-item:last-child, .payment-item:last-child {
        border-bottom: none;
        padding-bottom: 0;
    }

    .load-route, .shipment-route {
        font-weight: 500;
        color: #fff;
        margin-bottom: 0.25rem;
    }

    .load-details, .shipment-details {
        font-size: 0.875rem;
        color: #a3a3a3;
    }
    ...
    .status-assigned, .status-in-transit, .status-available {
        color: #3b82f6;
